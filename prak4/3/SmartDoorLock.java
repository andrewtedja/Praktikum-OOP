...
public class SmartDoorLock extends SecurityDevice implements EnergyMonitored {
    ...
    public int getEnergyEfficiencyRating() {
        // TODO: Implementasi
        return (int) ((batteryLevel-1) / 20) + 1;
    }
    ...
    public void chargeBattery(int amount) {
        ...
        if (batteryLevel > MAX_BATTERY){
            ...
            System.out.print("Battery charged to ");
    ...
    private void useBattery(int amount) {
        ...
        if (batteryLevel <= 0){
            batteryLevel = 0;
            super.turnOff();
            System.out.print("Warning: Battery depleted, device turned off");
        } else if (batteryLevel < 20){
            System.out.print("Warning: Low battery (");
            System.out.print(batteryLevel);
            System.out.println("%)");
        }
    }
