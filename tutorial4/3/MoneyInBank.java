public class MoneyInBank implements MoneyTransaction{
    ...
    public MoneyTransaction add(MoneyTransaction money) {
        ...
        MoneyInBank test = new MoneyInBank(newAmount, this.interestRate, this.totalLoanAmount);
        return test;
    }
    ...
    public MoneyTransaction subtract(MoneyTransaction money) {
        ...
        if (newAmount >= 0){
            ...
            MoneyInBank test = new MoneyInBank(0, this.interestRate, this.totalLoanAmount);
            return test;
        }
    }
